...
Textures = function () {
  ...
  var dirtTexture = new PIXI.Texture.fromImage('textures/dirt.png');

  var grassTexture = new PIXI.Texture.fromImage('textures/grassTexture.png');
  var spikeTexture = new PIXI.Texture.fromImage('textures/spike.png');
  var bouncyTexture = new PIXI.Texture.fromImage('textures/texture_bouncy.png');
