...
var SoundController = function () {
  ...
  var blop = new Howl({
    urls: ['./sounds/blop.m4a']
  }).volume(0.4);;
  var jump = new Howl({
    urls: ['./sounds/jump_shorter.mp3']
  }).volume(0.15);
  var squish = new Howl({
    urls: ['./sounds/small_splat.mp3']
  }).volume(0.3);;
  var spring = new Howl({ urls: ['./sounds/spring_short.mp3'] }).volume(.3);
  var star = new Howl({ urls: ['./sounds/star.mp3'] }).volume(.08);
  var key = new Howl({ urls: ['./sounds/key.mp3'] }).volume(.1);
  var bing1 = new Howl({ urls: ['./sounds/bing_1.mp3'] }).volume(.01);
  var bingFinal = new Howl({ urls: ['./sounds/bing_final.mp3'] }).volume(.05);
